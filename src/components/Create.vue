                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input class="form-check-input" name="editable" v-model="role.editable" type="checkbox" id="editable">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <div class="form-check">
                                <input class="form-check-input" checked  name="active" v-model="role.active" type="checkbox" id="active">
...
export default ({
    ...
    methods:{
        addRole(){
            ...
            var nextId = (this.rolesData[this.rolesData.length - 1].id - (-1));  
            var dataToSend = {id: nextId, name: this.role.name, type:this.role.type, description:this.role.description, 
            editable:this.role.editable, active:this.role.active, users:this.users, created_on: this.timestamp, modified_on: ''};

            this.rolesData.push(dataToSend);

            console.log(this.rolesData);
            fetch('http://localhost/roles/?insert',{
                method:"POST",
